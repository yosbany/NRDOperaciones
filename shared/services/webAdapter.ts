// Adaptador para la app web (React)
import { dataAccess } from './dataAccess';
import { Orden, Producto, Proveedor, Tarea, User, RecetaCosto } from './types';

// Adaptador para React Web
export class WebDataAdapter {
...
// Instancia singleton para web
export const webDataAdapter = new WebDataAdapter();
