...
import { canAccessTab, deleteProveedor, getOrdenes, getProductos, getProductosDefaultCliente, getProveedores, logEvento, Producto, Proveedor, saveProveedor, updateProductosDefaultCliente, updateProveedor } from '../../services/firebase';
